...
const RADIUS = 100; // Coordinates of the center based on the radius
...
function describePath(radius, startAngle, endAngle) {
  ...
  const d = ['M', start.x, start.y, 'A', radius, radius, 0, largeArcFlag, 0, end.x, end.y, 'L', X_CENTER, Y_CENTER //Y_CENTERER,
  ].join(' ');
  return d;
}
...
var script = {
  ...
  computed: {
    ...
    separatorPaths() {
      ...
      if (separatorStep > 0) {
        const paths = []; // If the gauge is a circle, this will add a separator at the start
    ...
    scaleLines() {
      ...
      if (scaleInterval > 0) {
        const lines = []; // if gauge is a circle, remove the first scale
  ...
  watch: {
    ...
    value: {
      ...
      handler(next) {
        ...
        }, transitionDuration).easing(get_1(TWEEN.Easing, easing)).onUpdate(object => {
  ...
  methods: {
    ...
    getAngle(value) {
      const {
        ...
        startAngle,
        totalAngle
      } = this; // Make sure not to divide by 0
...
var __vue_render__ = function () {
  ...
  }, [_vm.header ? _c('figcaption', {
    staticClass: "uibgauge-header"
  }, [_c('span', {
    domProps: {
  ...
  })], 1), _vm._v(" "), _vm.hasGradient ? _c('linearGradient', {
    attrs: {
  ...
  }), 1) : _vm._e(), _vm._v(" "), _c('mask', {
    attrs: {
      "id": "innerCircle-" + _vm._uid
    }
  }, [_c('circle', {
    attrs: {
      "r": _vm.RADIUS - 0.5,
  ...
  }), _vm._v(" "), _vm.separatorPaths ? _vm._l(_vm.separatorPaths, function (separator, index) {
    return _c('path', {
      key: index,
      attrs: {
        "d": separator,
  ...
  }) : _vm._e()], 2)], 1), _vm._v(" "), _c('g', {
    attrs: {
      "mask": "url(#innerCircle-" + _vm._uid + ")"
    }
  }, [_vm.isCircle ? _c('circle', {
    attrs: {
      "r": _vm.RADIUS,
      "cx": _vm.X_CENTER,
      "cy": _vm.Y_CENTER,
      "fill": _vm.hasGradient ? "url(#gaugeGradient-" + _vm._uid + ")" : _vm.gaugeColor
    }
  }) : _c('path', {
    attrs: {
      "d": _vm.basePath,
  ...
  }), _vm._v(" "), _vm.value === _vm.min && _vm.isCircle ? _c('circle', {
    attrs: {
      "r": _vm.RADIUS,
      "cx": _vm.X_CENTER,
      "cy": _vm.Y_CENTER,
  ...
  })]), _vm._v(" "), _vm.scaleLines ? _vm._l(_vm.scaleLines, function (line, index) {
    return _c('line', {
      key: line.xE + "-" + index,
      attrs: {
        "x1": line.xS,
  ...
  }, [_vm._t("default")], 2)], 2) : _vm._e()]), _vm._v(" "), _vm.caption ? _c('figcaption', {
    staticClass: "uibgauge-caption"
  }, [_c('span', {
    domProps: {
...
const __vue_scope_id__ = "data-v-78d43347";
/* module identifier */
...
const __vue_scope_id__$1 = "data-v-7c2c2350";
/* module identifier */
...
var __vue_render__$2 = function () {
  ...
  return _c('div', {
    staticClass: "uibuilder-vuejs-component-extras-sample"
  }, [_c('test1'), _vm._v(" "), _c('p', [_vm._v("The counter was " + _vm._s(_vm.changedBy) + " to "), _c('b', [_vm._v(_vm._s(_vm.counter))]), _vm._v(".")]), _vm._v(" "), _c('button', {
    on: {
      "click": _vm.increment
    }
  }, [_vm._v("\n    Click +1\n  ")]), _vm._v(" "), _c('button', {
...
const __vue_scope_id__$2 = "data-v-72453b18";
/* module identifier */
...
var components = /*#__PURE__*/Object.freeze({
    __proto__: null,
    Gauge: __vue_component__,
    test: __vue_component__$2,
    test1: __vue_component__$1
});

// Import vue components

const install = function installUibuilderVuejsComponentExtras(Vue) {
...
export { __vue_component__ as Gauge, __vue_component__$2 as test, __vue_component__$1 as test1 };
